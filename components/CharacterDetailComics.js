...
class CharacterDetailComics extends React.Component {
  goDetailPage = () => {
  ...
  render() {
    ...
    return (
      <Block row={horizontal} card flex style={cardContainer}>
        {item.image && <TouchableWithoutFeedback
...
CharacterDetailComics.propTypes = {
...
export default withNavigation(CharacterDetailComics);
